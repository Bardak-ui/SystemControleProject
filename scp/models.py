...
class Project(models.Model):
    ...
    language = models.CharField(max_length=50, choices=Language.LANGUAGE_CHOICES, verbose_name='Язык программирования',default='Not specified')
    status = models.CharField(max_length=50,choices=Status.STATUS_CHOICES, verbose_name="Статус",default='Waiting')
...
class Task(models.Model):
    ...
    priority = models.CharField(max_length=50, choices=Status.PRIORITY_CHOICES, verbose_name="Статус",default='Not specified')
    status = models.CharField(max_length=50,choices=Status.STATUS_CHOICES, verbose_name="Cтатус",default='Waiting')
    created_at = models.DateField(auto_now_add=True)
    # updated_at = models.DateField() #Реализовать дату последнего обновления
